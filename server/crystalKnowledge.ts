...
export const knowledgeChunks: KnowledgeChunk[] = [
  ...
  },
  {
    ...
    answer: "早鳥優惠價 12,888 元（共 6 小時），兩人同行再減 888 元/人。地點：桃園小檜溪區（預約制）。課程分三段：①理論/創業基礎（2hr）②手作 3 件作品（3hr）③淨化保養與連結（0.5hr）。6 種核心製作技法包含彈力繩獨家不易鬆脫綁法、磁扣、龍蝦扣、U 型扣、項鍊、吊飾，IG 分享可獲贈品。報名請私訊 LINE：https://line.me/R/ti/p/@011tymeh",
