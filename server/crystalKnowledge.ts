...
export const knowledgeChunks: KnowledgeChunk[] = [
  ...
  },
  {
    ...
    answer:
      "我們提供免費一次改初版與維修可調整範圍內的修改；但不接受改手圍、新增條件（例如要銀管、要珠框、不要紫色、要磁扣等），因為這些屬於重新打掉設計，需加收 200 元，請在預約時直接透過官方 LINE 跟老闆說明🤍 初版與維修在免費範圍內可調整的部分：有不喜歡的配飾可以更換、水晶／配飾擺放順序可調整，有不清楚的也歡迎詢問。若想再改第二次（含超出免費範圍的變更），需加收 200 元。LINE：https://line.me/R/ti/p/@011tymeh",
    embedText:
  ...
  },
  {
    ...
    answer:
      "可以，但這類屬於「新增條件」或改手圍，等於重新打掉設計，不在免費一次範圍內，需加收 200 元。請在預約或討論設計時就先透過官方 LINE 跟老闆說明。LINE：https://line.me/R/ti/p/@011tymeh",
    embedText:
