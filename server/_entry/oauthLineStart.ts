// Vercel：GET /api/oauth-line-start（vercel.json 將 /api/oauth/line/start rewrite 至此）
import type { IncomingMessage, ServerResponse } from "node:http";
import express, { type NextFunction } from "express";
import { lineOAuthStart } from "../lineOAuthRoutes";

const PATH = "/api/oauth-line-start";
