...
export default function CustomFormD() {
  ...
  const depositProduct = products.find((p) => p.id === "numerology-crystal-deposit-product");
    ...
    <div className="min-h-screen bg-[oklch(0.98_0.005_240)] page-enter">
      ...
      <div className="border-b border-[oklch(0.93_0_0)] bg-white">
        <div className="max-w-2xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div>
            <p className="text-[0.6rem] tracking-[0.2em] text-[oklch(0.55_0_0)] uppercase">生命靈數 × 水晶手鍊</p>
            ...
            {steps.map((_, i) => (
              <div
                ...
                className={`h-1.5 flex-1 rounded-full transition-colors ${
                  i <= step ? "bg-[oklch(0.68_0.11_30)]" : "bg-[oklch(0.88_0_0)]"
                }`}
              />
            ))}
          </div>
