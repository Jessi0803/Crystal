...
export default function CustomForm() {
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              ...
              >
                ...
                <p className={`text-sm font-body text-center py-2.5 ${
                  form.claspType === opt.id ? "bg-[oklch(0.97_0_0)] font-semibold" : "text-[oklch(0.45_0_0)]"
                }`}>
  ...
  const handleNext = () => {
    ...
    if (step === 4 && !form.silverTube) { toast.error("請選擇是否加銀管"); return; }
    if (step === 5 && !form.beadFrame) { toast.error("請選擇是否加珠框"); return; }
    setStep((s) => s + 1);
  };
