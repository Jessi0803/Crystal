...
export const products: Product[] = [
  ...
  },
  {
    ...
    image: "/logo.png",
    tags: ["客製化", "訂金", "脈輪"],
    description: "脈輪檢測 × 水晶手鍊客製化服務訂金專用商品。老闆確認需求後，會另外提供尾款付款連結。",
    story: "此商品用於脈輪檢測 × 水晶手鍊客製化服務的訂金下單。完成訂金付款後，訂單會進入「已付訂金」，待老闆確認內容後可產生尾款付款連結。",
    benefits: [
      "保留脈輪檢測 × 水晶手鍊客製化製作排程",
      "作為客製化服務的訂金憑證",
      "老闆可於後台產生尾款付款連結",
  ...
  },
  {
    ...
    image: "/logo.png",
    tags: ["客製化", "訂金", "生命靈數"],
    description: "生命靈數 × 水晶手鍊客製化服務訂金專用商品。老闆確認需求後，會另外提供尾款付款連結。",
    story: "此商品用於生命靈數 × 水晶手鍊客製化服務的訂金下單。完成訂金付款後，訂單會進入「已付訂金」，待老闆確認內容後可產生尾款付款連結。",
    benefits: [
      "保留生命靈數 × 水晶手鍊客製化製作排程",
      "作為客製化服務的訂金憑證",
      "老闆可於後台產生尾款付款連結",
