...
export const products: Product[] = [
  {
    ...
    howToUse: [
      "此商品為訂金專用",
      "下單後請加入官方 LINE 留下訂單編號跟姓名，以便收到手鍊設計完後的成品圖",
      "支付尾款",
    ],
    disclaimer: "此商品為客製化服務訂金，實際尾款金額由老闆確認後另行通知。",
    inStock: true,
    featured: false,
    crystalType: "可提供想要的功效、色系、款式，或是也可以跟我討論｜如愛情、溝通能力、財運、疾病等等｜提供初版免費修改 1 次",
    color: "訂金",
  },
  {
    ...
    inStock: true,
    featured: false,
    crystalType: "提供塔羅解析，透過解析分析出缺失的能量，利用水晶能量補足｜也可以許願想額外加強的能量！｜提供初版免費修改 1 次｜加購的塔羅占卜打 9 折",
    color: "訂金",
  },
  {
    ...
    inStock: true,
    featured: false,
    crystalType: "以靈擺與塔羅測出您的七脈輪能量狀況｜提供一份專屬脈輪檢測報告｜利用水晶能量補足脈輪能量缺失｜也可以許願想額外加強的能量！｜提供初版免費修改 1 次｜加購脈輪檢測 500 元",
    color: "訂金",
  },
  {
    ...
    inStock: true,
    featured: false,
    crystalType: "透過西元出生年月日找出天賦數、生命數、先天數、星座數｜找出缺數並透過生命數與缺數做能量搭配｜也可以許願想額外加強的能量！｜提供初版免費修改 1 次｜加購生命靈數檢測 500 元",
    color: "訂金",
  },
  {
    id: "d001-moon-secret",
